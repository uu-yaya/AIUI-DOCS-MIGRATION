---
title: 技能后处理协议：Request_v2.1协议
source_url: https://aiui-doc.xf-yun.com/project-1/doc-73/
---
...
- 所有发送给技能的请求Header都包含`Signature`字段（[校验步骤](https://aiui-doc.xf-yun.com/project-1/doc-72/)）

---
title: 合成能力使用
source_url: https://aiui-doc.xf-yun.com/project-1/doc-789/
---
...
在通用大模型链路下，所有超拟人都免费开放开发者使用。各超拟人发音人信息见【[发音人列表](https://aiui-doc.xf-yun.com/project-1/doc-93/ "发音人列表")】。
...
声音复刻合成类请求，首先需要开发者按照`声音复刻API`注册获取资源id（`res_id`），资源注册详见【[4.2.4 声音复刻API](https://aiui-doc.xf-yun.com/project-1/doc-787/ "4.2.4 声音复刻API")】文档说明。

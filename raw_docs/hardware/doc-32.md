---
title: 集成方式
source_url: https://aiui-doc.xf-yun.com/project-1/doc-32/
---

# 接入方式

AIUI 评估板提供了多种集成方式。在后期量产时，请[联系我们](https://aiui-doc.xf-yun.com/project-1/doc-83/)获取更完整的集成流程。
...
开发者APP集成[AIUIServiceKit](https://aiui-doc.xf-yun.com/project-1/doc-34/)，运行在AIUI模块上，从AIUIService获取结果，进行解析处理，与评估板上AIUIProductDemo的效果类似，完整结构如下图所示：

<!-- TODO: 需手动补充图片，原始 URL: https://aiui-file.cn-bj.ufileos.com/aiui-doc/3_access_service/access_evm/screenshot_1519544156229.png -->
![待补充：AIUI 评估板集成架构图01](/_images/placeholder.svg)

具体集成方法请参见[AIUIServiceKit SDK](AIUIServiceKitSDK.md)，对AIUI核心板模块有任何疑问的可参考[`AIUI模块数据手册`](https://xfyun-doc.cn-bj.ufileos.com/1519542857029703/AIUI模块XFAI0801数据手册V0.3.pdf)。
...
软核模式和[核心板模式](https://aiui-doc.xf-yun.com/project-1/doc-32/#核心板模式)的软件结构是一样的，区别在于软核模式将AIUIService及其他Apk运行在开发者的硬件上（操作系统需要是Android）。
...
具体的要求和对接开发事项请[联系我们](https://aiui-doc.xf-yun.com/project-1/doc-83/)。
...
③ 开发集成参考[核心板模式](https://aiui-doc.xf-yun.com/project-1/doc-32/#核心板模式)。
...
![待补充：AIUI 评估板集成架构图02](/_images/placeholder.svg)
...
具体集成方法请参见[串口SDK](https://aiui-doc.xf-yun.com/project-1/doc-35/)。

---
title: 声音复刻
source_url: https://aiui-doc.xf-yun.com/project-1/doc-801/
---
...
- 声音复刻合成参数示例：
  ...
  > scene：**IFLYTEK.tts**
- 合成请求示例（Android）：
  下面提供合成文本一帧发送完毕方式，合成文本分帧流式合成调用详见文档【[3.6.3 流式合成](https://aiui-doc.xf-yun.com/project-1/doc-800/ "3.6.3 流式合成")】说明。

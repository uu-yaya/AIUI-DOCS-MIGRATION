---
title: 语音合成
source_url: https://aiui-doc.xf-yun.com/project-1/doc-23/
---
...
[发音人列表](https://aiui-doc.xf-yun.com/project-1/doc-93/)详细了解。

[**- 1.合成调用>>>点击跳转**](#合成调用)
[**- 2.结果解析>>>点击跳转**](#结果解析)
[**- 3.播放处理>>>点击跳转**](#播放处理)
[**- 4.过滤合成标记>>>点击跳转**](#过滤合成标记)
...
[-1. 在线主动合成>>>点击跳转](#在线主动合成)
[-2. 离线主动合成>>>点击跳转](#离线主动合成)

#### 1.2.1. 在线主动合成

**发音人激活**
主动合成方式需要端侧在请求参数中指定发音人名称，故使用的发音人要先确认以激活授权。
AIUI平台提供很多免费发音人，详见【[发音人列表](https://aiui-doc.xf-yun.com/project-1/doc-93/ "发音人列表")】说明。免费发音人激活方式：
...
| **tts** | 合成参数 | ent | 是 | **合成引擎类型** 固定取值 xtts |

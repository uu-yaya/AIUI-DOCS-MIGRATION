---
title: AIUI SDK接入流程
source_url: https://aiui-doc.xf-yun.com/project-1/doc-7/
---
...
[**- SDK接入流程>>>点击跳转**](#SDK接入流程)

[**- SDK集成指导>>>点击跳转**](#SDK集成指导)

[-Android 集成步骤>>>点击跳转](#Android 集成步骤)

[-Windows&Linux 集成步骤>>>点击跳转](#Windows&Linux 集成步骤)

[-iOS 集成步骤>>>点击跳转](#iOS 集成步骤)

## 前言

AIUI平台SDK，目前主要覆盖主流开发平台，包括:Android、Windows、Linux、Ios，该类SDK开发者可以通过创建AIUI应用，在应用管理的资源下载页面可直接下载。
另外AIUI针对广大rtos系统对接需求，基于平台最新的极速超拟人服务体系也适配了一套SDK，可以【[查看文档](https://aiui-doc.xf-yun.com/project-1/doc-802/)】详细了解。

## SDK接入流程

对接AIUI SDK做程序开发前，首先需要先了解AIUI SDK的服务接口、业务参数、结果回调等。这些部分都可以通过文档 【[AIUI SDK基础信息](https://aiui-doc.xf-yun.com/project-1/doc-11/ "AIUI SDK基础信息")】查看了解。
当了解完AIUI SDK基础部分后，就可以进行SDK集成开发了。程序开发需要注意一下两点：

- 业务能力
   AIUI平台默认下载的AIUI SDK仅支持在线语音服务，除语音唤醒外，如需其他离线能力可以联系讯飞商务申请线下提供AIUI SDK和引擎资源。
- 服务链路
   根据AIUI应用实际使用的服务链路，对应查看【[传统语义链路接入](https://aiui-doc.xf-yun.com/project-1/doc-790/ "传统语义链路接入")】、【[通用大模型链路接入](https://aiui-doc.xf-yun.com/project-1/doc-791/ "通用大模型链路接入")】、【[极速超拟人链路接入](https://aiui-doc.xf-yun.com/project-1/doc-792/ "极速超拟人链路接入")】调用方式，各个服务链路的区别详见【[AIUI服务链路介绍](https://aiui-doc.xf-yun.com/project-1/doc-403/ "AIUI服务链路介绍")】说明。至于当前AIUI应用具体使用的哪个服务链路，可以查看【[AIUI应用介绍](https://aiui-doc.xf-yun.com/project-1/doc-769/ "AIUI应用介绍")】了解。

![](/media/202509/2025-09-16_174624_9954980.5898940674594813.png "null")
...
![](/media/202508/2025-08-15_170442_8356490.26842023261177794.png "null")

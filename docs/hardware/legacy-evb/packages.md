...
![](/images/placeholder.svg "原图：./images/kuangjia.png")
...
该目录下包含AIUIServiceKit.jar，开发者可在自己开发的评估板应用中集成该库，用来与AIUIService进行通信。详细使用可参考[AIUIServiceKit SDK](/hardware/legacy-evb/aiui-service-kit)。

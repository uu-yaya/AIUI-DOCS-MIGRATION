...
2、**普通发音人**调用方式见[3.3.4 语音合成](/sdk-dev/features/tts)文档说明。

3、AIUI平台支持的发音人及分类详见[3.8 发音人列表](/sdk-dev/voice-list)说明。

## 调用说明

### 确认参数

在通用大模型交互链路下，所有超拟人都免费开放开发者使用。各超拟人发音人信息见[发音人列表](/sdk-dev/voice-list "发音人列表")。

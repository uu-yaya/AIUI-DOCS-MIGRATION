...
![流式识别示意](/media/202212/2022-12-31_150858_5697510.13813317141714532.gif)

## 开启方法

在AIUI应用的`语音识别配置`项下勾选`progressive 流式识别`选项，及代表开启了流式识别能力。

![](/media/202508/2025-08-20_154653_6893550.46462539284416615.png)

## 结果解析说明

开始流式识别配置后，AIUI SDK监听回调`EVENT_RESULT`事件，解析 sub=IAT（语音识别）：

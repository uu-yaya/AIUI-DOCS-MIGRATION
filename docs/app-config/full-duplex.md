...
::: info 概述
全双工交互通过三层 VAD（端点检测）能力，让设备支持自然流畅的连续对话，无惧环境噪音与误触发。
...
语音活动检测 (Voice Activity Detection，VAD（端点检测）) 能区分音频中的人声和背景噪声，判断交互人何时在与设备说话。在全双工交互体验中，VAD的准确性是保证人机对话过程不会互相打断的重要能力。

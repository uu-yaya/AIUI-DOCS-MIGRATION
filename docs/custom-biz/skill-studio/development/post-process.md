...
![待补充：技能后处理流程图](/images/placeholder.svg)
...
1、AIUI平台自定义技能已全量升级切换到 v2.1协议，云函数技能后处理开发请查看【[云函数APIv2.1](/custom-biz/skill-studio/cloud-function-api-v21) 】文档说明
...
![待补充：云函数架构图](/images/placeholder.svg)
...
云函数有全局变量 AIUI，用于打印日志的 console。点击查看更多云函数接口：[v2.0](/custom-biz/skill-studio/cloud-function-api-v20)，[v2.1](/custom-biz/skill-studio/cloud-function-api-v21)
...
![待补充：云函数调用示例截图](/images/placeholder.svg)
...
![待补充：Webhook 架构图](/images/placeholder.svg)

使用Webhook流程

- 在平台填写技能部署地址（URL地址）
- 技能需要验证发送的请求，验证步骤请参考[技能请求校验](/custom-biz/protocols/post-process-verify)。

### 注意：

Webhook只支持[v2.1协议](/custom-biz/skill-studio/cloud-function-api-v21)。
